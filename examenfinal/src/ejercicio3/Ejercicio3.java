...
public class Ejercicio3 {
       public static void calcularValorInventario() {
          ...
          System.out.println("Escribe un programa en Java que lea un archivo de texto llamado \"datos.txt\" \nque contiene"
                  + " información sobre productos (nombre, precio y cantidad en stock). "
                  + "\nCalcula el valor total del inventario y guarda el resultado en un nuevo "
                  + "archivo llamado \"inventario.txt\".\n");
